...
import me.THEREALWWEFAN231.funnelmc.translator.container.type.ContainerTypeTranslator;
...
public class ContainerOpenPacketTranslator extends PacketTranslator<ContainerOpenPacket> {
	...
	public void translate(ContainerOpenPacket packet) {
		...
		MenuType<?> screenHandlerType = ContainerTypeTranslator.bedrockToJava(packet.getType());
		...
		ClientboundOpenScreenPacket openScreenS2CPacket = new ClientboundOpenScreenPacket(packet.getId() & 0xff, screenHandlerType, Component.literal("Name TODO"));
