...
public class FakeJavaConnection {
	...
	public FakeJavaConnection() {
		...
		CommonListenerCookie cookie = new CommonListenerCookie(null, gameProfile, null, RegistryAccess.EMPTY, FeatureFlags.VANILLA_SET, "tunnelmc",
				null, null, Collections.emptyMap(), null, Collections.emptyMap(), ServerLinks.EMPTY, Collections.emptyMap(), false);
		this.clientPacketListener = new ClientPacketListener(TunnelMC.mc, this.connection, cookie);
